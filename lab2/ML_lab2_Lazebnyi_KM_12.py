...
def pt_three(data_frame):
    ...
    # 3rd. task pt. a
    predictions_df_m1 = get_predictions(data_frame['GT'], data_frame['Model_1_1'], x_values)
    predictions_df_m2 = get_predictions(data_frame['GT'], data_frame['Model_2_1'], x_values)
    ...
    precision_for_curve_m1, recall_for_curve_m1, thresholds_pr_m1 = precision_recall_curve(data_frame['GT'],
                                                                                           data_frame['Model_1_1'])
    precision_for_curve_m2, recall_for_curve_m2, thresholds_pr_m2 = precision_recall_curve(data_frame['GT'],
                                                                                           data_frame['Model_2_1'])
    ...
    fpr_m1, tpr_m1, thresholds_roc_m1 = roc_curve(data_frame['GT'], data_frame['Model_1_1'])
    fpr_m2, tpr_m2, thresholds_roc_m2 = roc_curve(data_frame['GT'], data_frame['Model_2_1'])
    ...
    class_0_objects_m1 = data_frame.loc[data_frame['GT'] == 0, 'Model_1_1']
    class_1_objects_m1 = data_frame.loc[data_frame['GT'] == 1, 'Model_1_1']
    ...
    class_0_objects_m2 = data_frame.loc[data_frame['GT'] == 0, 'Model_2_1']
    class_1_objects_m2 = data_frame.loc[data_frame['GT'] == 1, 'Model_2_1']
...
class_1_objects = df[df['GT'] == 1]

num_objects_to_remove = int(len(class_1_objects) * percent_to_remove / 100)

random_indices = np.random.choice(class_1_objects.index, num_objects_to_remove, replace=False)

new_df = df.drop(random_indices)

# Now we're working with new_df dataframe
print(new_df.head())
print()

print('''6. Вивести відсоток видалених об’єктів класу 1 та кількість елементів кожного
класу після видалення.\n''')
print(f"Відсоток видалених об'єктів = {percent_to_remove}%\n")
